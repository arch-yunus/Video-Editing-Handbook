...
Videonun renk verisini nasıl sıkıştırdığını belirler:
- **4:2:0:** Çoğu tüketici kamerası ve web yayını. Renk verisi parlaklık verisinden daha azdır.
- **4:2:2:** Profesyonel kameralar. Renk grading için daha fazla veri sunar, yeşil ekran (green screen) işleri için idealdir.
- **4:4:4:** Sıkıştırmasız renk verisi. VFX ve yüksek bütçeli sinema işleri için kullanılır.
...
### 📶 Bitrate Türleri
- **CBR (Constant Bitrate):** Tüm video boyunca sabit veri akışı. Boyut tahmin edilebilir ama verimsizdir.
- **VBR (Variable Bitrate):** Haraketli sahnelerde veri artar, durağan sahnelerde azalır. En iyi kalite/boyut dengesini sağlar. (Genellikle **VBR 2-Pass** en temiz sonucu verir.)
...
- **1080p (Progressive):** Her kare tam bir resimdir. Modern web ve dijital ekran standartıdır.
- **1080i (Interlaced):** Her kare yarım satırlardan oluşur. Eski TV yayıncılığı standartıdır. **Mümkünse her zaman Progressive (p) kullanın.**
